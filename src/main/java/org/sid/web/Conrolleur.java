...
@GetMapping(path = "/villes")
	...
	public String savePatient(Model model ,@Validated Ville ville,BindingResult bindingResult) {
...
public String savePatient(Model model ,@Validated Cinema cinema,BindingResult bindingResult) {
...
public String saveSalle(Model model ,@Validated Salle salle,BindingResult bindingResult) {
...
public String saveFilm(Model model ,@Validated Film film,BindingResult bindingResult) {
...
public String saveProjection(Model model ,@Validated ProjectionFilm projectionFilm,BindingResult bindingResult) {
...
public String saveTicket(Model model ,@Validated Ticket ticket,BindingResult bindingResult) {
